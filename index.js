...
var sevenSummits = ["everest", "anconcagua", "denali", "elbrus", "kilimanjaro", "vinson", "kosciuszko"];
var randomIndex = Math.floor(Math.random() * sevenSummits.length);
var randomWord = sevenSummits[randomIndex];
